...
*/
        ...
        if(hay_zombie_diago(diagz[0],diagz[1],diagz[2],diagz[3],pos_zombie) and cell(pos_act_p+zd).type!=Waste) {
          zombie_diago(diagz[0],diagz[1],diagz[2],diagz[3],pos_zombie,zd);
          move(id,zd);
        }
        else {
